...
/**
 * Created by LP on 2017/8/29/19:00.
 */
...
public final class GlideUtil {
     ...
     * @param imageView
     */
    public static void loadImage(int imageRes, ImageView imageView) {
    ...
    public static void loadRoundImage(File file, ImageView imageView) {
        Context context = imageView.getContext();
        Glide.with(context)
                .load(file)
                .dontAnimate()
    ...
    public static void loadRoundImage(Uri uri, ImageView imageView) {
        Context context = imageView.getContext();
        Glide.with(context)
                .load(uri)
                .dontAnimate()
    ...
    public static void loadUrlWithoutCrop(String imgUrl, ImageView imageView){
        Context context = imageView.getContext();
        Glide.with(context)
                .load(imgUrl)
                .dontAnimate()
